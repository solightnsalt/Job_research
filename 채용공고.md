...
+ 자격 요건
  ...
  +  React, Vue 등 SPA 프레임워크 개발 경험
  + ES6, HTML, CSS에 대한 깊은 이해
  + CSS IN JS 개발 경험
  + 강한 자율성과 책임감
...
+ 우대 사항
  ...
  + GIT, JIRA 등 개발자 협업도구 사용 경험

  

+ 기술 스택, 툴

  + VueJS, CSS, HTML, JavaScript, TypeScript, React.js, ES6
...
+ 우대 사항
  ...
  + PostgreSQL에 대한 이해
  + Git 형상 관리 경험
  + TensorFlow 및 TensorFlow Tools의 이해
  + Cloud Platform에 대한 이해
  + Flask Framework에 대한 이해
